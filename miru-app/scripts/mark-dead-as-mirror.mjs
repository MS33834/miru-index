...
const KNOWN_BLOCKED_DOMAINS = new Set([
  ...
  'gemini.google.com', 'podcasts.google.com', 'fonts.google.com',
  'fonts.googleapis.com', 'translate.google.com',
  // 微软 / 网盘
  'onedrive.live.com', 'dropbox.com', 'mega.nz', 'mega.io',
  // Meta
  'facebook.com', 'instagram.com', 'whatsapp.com',
  // 创意平台
  'behance.net', 'dribbble.com', '500px.com', 'artstation.com',
  'deviantart.com', 'pixiv.net', 'pixivic.com', 'pinterest.com',
  // 视频 / 直播
  'youtube.com', 'youtu.be', 'twitch.tv', 'vimeo.com',
  'abema.tv', 'disneyplus.com', 'netflix.com', 'funimation.com',
  'crunchyroll.com', 'hidive.com', 'bilibili.com',
  // 社交 / 论坛
  'twitter.com', 'x.com', 'reddit.com', 'discord.com', 'discord.gg',
  'threads.net', 'bsky.app', 't.me', 'telegram.org',
  // 音乐 / 音频
  'spotify.com', 'open.spotify.com', 'soundcloud.com', 'bandcamp.com',
  'tidal.com', 'deezer.com', 'kkbox.com', 'podbean.com', 'castbox.fm',
  'overcast.fm', 'pocketcasts.com', 'podcasts.apple.com',
  // 维基 / 文档
  'wikipedia.org', 'fandom.com', 'archive.org', 'wikimedia.org',
  // AI / 模型
  'huggingface.co', 'civitai.com', 'replicate.com', 'openai.com',
  'chat.openai.com', 'chatgpt.com', 'anthropic.com', 'claude.ai',
  'midjourney.com', 'perplexity.ai', 'poe.com', 'suno.ai',
  'udio.com', 'leonardo.ai', 'leonardoai.com', 'runwayml.com',
  'elevenlabs.io', 'descript.com', 'gemini.google.com',
  // 设计 / 协作
  'figma.com', 'sketch.com', 'notion.so', 'obsidian.md',
  'logseq.com', 'excalidraw.com', 'codepen.io', 'stackoverflow.com',
  'developer.mozilla.org', 'caniuse.com', 'regex101.com', 'devdocs.io',
  'ascii2d.net', 'saucenao.com', 'iqdb.org', 'trace.moe',
  '3d.iqdb.org', 'wallhaven.cc', 'zerochan.net',
  // 出版 / 阅读
  'archiveofourown.org', 'syosetu.com', 'kakuyomu.jp',
  'royalroad.com', 'webtoons.com', 'tapas.io', 'myanimelist.net',
  'anilist.co', 'vndb.org', 'anidb.net',
  // 游戏
  'store.steampowered.com', 'steamcommunity.com', 'steamdb.info',
  'store.epicgames.com', 'gog.com', 'ign.com', 'gamefaqs.gamespot.com',
  // 学习
  'khanacademy.org', 'coursera.org', 'edx.org', 'udemy.com',
  'crashcourse.com', 'thecrashcourse.com',
  // 综合
...
function loadDeadSet() {
  return fs.readFile(HEALTH_JSON, 'utf8')
    .then((s) => JSON.parse(s))
    .then((h) => {
      const set = new Set()
