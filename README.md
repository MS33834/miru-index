...
> 一个 ACGN 资源导航站，收录梯子 / 下载器 / 解压 / 搜图 / GalGame / 番剧 / 游戏 / 书籍 / 开源工具等站点，支持搜索、分类、标签浏览与收藏导出。
>
> 🌐 **在线访问**：GitHub Pages `https://MS33834.github.io/miru-index/`
>
> ⚠️ 本仓库仅做开源项目与公开网站导航索引，**不托管、不分发任何受版权保护的内容**。请使用者遵守各项目对应的开源协议以及相关网站的使用条款。
...
| 名称 | 简介 | 语言 | 最近更新 | 仓库 |
| --- | --- | --- | --- | --- |
| **manga-image-translator** | 漫画图片翻译器：OCR + 17 种翻译引擎 + 嵌字，支持日 / 英 / 韩 / 中互译；提供 Web / CLI / Docker / API | Python | 持续维护（2k+ commits） | [zyddnys/manga-image-translator](https://github.com/zyddnys/manga-image-translator) |
